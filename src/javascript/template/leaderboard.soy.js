...
ffc.template.leaderboard.table = function(opt_data, opt_ignored) {
  return '<table class="table table-striped table-hover"><thead><tr><th colspan="2">User</th><th class="leaderboard-clues">Clues</th><th class="leaderboard-score">Score</th><th class="leaderboard-answered">Answered</th><th class="leaderboard-averageclues">Av. Clues</th><th class="leaderboard-average">Av. Score</th></tr></thead><tbody class="leaderboard-users"></tbody></table>';
};
